...
import com.sheet.commons.R;

import static com.menu.sheet.commons.MenuSheetView.MenuType.GRID;
import static com.menu.sheet.commons.MenuSheetView.MenuType.LIST;
...
public class MenuSheetView extends FrameLayout {
    ...
    private final ArrayList<SheetMenuItem> items = new ArrayList<>();
     ...
     * Call this before you attach to window using {@link MenuSheetLayout#showWithSheetView}.
