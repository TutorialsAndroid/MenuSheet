...
public interface ViewTransformer {
     ...
     */
    void transformView(float translation, float maxTranslation, float peekedTranslation, MenuSheetLayout parent, View view);
     ...
     */
    float getDimAlpha(float translation, float maxTranslation, float peekedTranslation, MenuSheetLayout parent, View view);
